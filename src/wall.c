 ...
 * based on factor value bet 0 and 1
 ...
 * @x: current elem in the rays array
*/
...
/**
 * renderCeil - render ceilling projection
 * @WallTopPixel: wall top pixel
 * @texelColor: texture color for curr pixel
 * @x: curr element in the rays array
*/
...
/**
 * renderWall - rendering wall projection
 *
*/
