...
/**
 * horzIntersection - it Finds horizontal intersection - wall
...
/**
 * vertIntersection - it Finds vertical intersection - wall
 * @rayAngle: current ray angle
 *
 */
