...
bool initializeWindow(void)
{
	...
	/* allocate the total amount of bytes in the memory to hold colorbuffer */
...
/**
 * destroyWindow - close window when the game is over
 *
*/
...
/**
 * clearColorBuffer - clearing buffer for every frame
 * @color: color buffer
*/
...
/**
 * renderColorBuffer - rendering buffer for every frame
 *
*/
...
/**
 * drawPixel - assigning a color to each pixel
