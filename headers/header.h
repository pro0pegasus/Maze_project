...
/* FUncs-vars-structs for map */
bool DetectCollision(float x, float y);
bool isInsideMap(float x, float y);
void renderMap(void);
int getMapValue(int row, int col);

/* Funcs-vars-structs for player */

/**
 * struct player_s - textures struct
 * @x: x coordinate
 * @y: y coordinate
 * @width: player width
...
/* Funcs-vars-structs for ray */

/**
 * struct ray_s - textures structs
 * @rayAngle: ray angle
...
/* Funcs-vars-structs for textures */

/**
 * struct texture_s - textures structs
 * @width: texture width
 * @height: texture height
 * @texture_buffer: ptr to texture buffer
 * @upngTexture: ptr to upng buffer
 *
 */
